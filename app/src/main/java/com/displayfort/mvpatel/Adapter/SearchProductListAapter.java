...
public class SearchProductListAapter extends RecyclerView.Adapter<SearchProductListAapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView mProductNameTextViewTv, mDetailtV;
        ...
        public ViewHolder(View view) {
            ...
            mDetailtV = (TextView) view.findViewById(R.id.productdetail_tv);
    ...
    public SearchProductListAapter(Context context, ArrayList<Product> searchList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.product_search_item, viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.mDetailtV.setText((Html.fromHtml(product.detail)));
        viewHolder.mDetailtV.setText(product.subCatName);
