 ...
 */
public class NFCProductFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static NFCProductFragment newInstance(Long catId) {
        NFCProductFragment contentFragment = new NFCProductFragment();
        ...
        homeViewHolder.mRecyclerViewRv.addOnItemTouchListener(
                new RecyclerItemClickListener(mContext, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        ((AddNfcToProductActivity) getActivity()).addFragment(ProductShortDetailFragment.newInstance(product.id,true), (product.name));
                    }
                }));
        ...
        try {
            Thread thread = new Thread() {
                ...
                public void run() {
                    ...
                    NFCProductFragment.this.bitmap = bitmap;
                }
            };
