 ...
 *
 */
public class NFCSubCategoryFragment extends BaseFragment implements View.OnClickListener {
    ...
    public static NFCSubCategoryFragment newInstance(int catId) {
        NFCSubCategoryFragment contentFragment = new NFCSubCategoryFragment();
        ...
        homeViewHolder.mRecyclerViewRv.addOnItemTouchListener(
                new RecyclerItemClickListener(mContext, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        ((AddNfcToProductActivity) getActivity()).addFragment(NFCProductFragment.newInstance(dao.id), (dao.name));
                    }
                }));
    }
            ...
            Thread thread = new Thread() {
                ...
                public void run() {
                    if (containerView != null) {
                        ...
                        NFCSubCategoryFragment.this.bitmap = bitmap;
                    }
                }
            };
