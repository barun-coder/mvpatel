...
public class AddProductListinProjectActivity extends BaseActivity {
    public static ArrayList<OrderDetailDao> cartProductOrderList;
    ...
    public static Intent getIntent(Context context) {
        Intent intent = new Intent(context, AddProductListinProjectActivity.class);
        return intent;
    }
